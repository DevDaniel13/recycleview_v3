                ...
                if(alumno == null || posicion == -1){
                    ...
                    if(validar()){
                        if(img != null){
                            ...
                            Toast.makeText(getApplicationContext(), "Captura de datos inválida", Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        Toast.makeText(getApplicationContext(), "Captura de datos inválida", Toast.LENGTH_SHORT).show();
        ...
        btnBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(posicion >= 0){
                    ...
                    confirmar.setTitle("¿Desea borrar al alumno?");
                    confirmar.setMessage("Se eliminarán todos los datos");
